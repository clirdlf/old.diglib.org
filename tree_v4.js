...
if(n02&&document.images ["N"+el.id].src&&document.images ["N"+el.id].src.indexOf('sxicon2.gif')!=-1)document.images ["N"+el.id].src=imf+"/sxicon3.gif"}
sxpind++}}}}
doAutoSync()}
...
if(n02&&elem.document.images ['N'+elem.id].src&&elem.document.images ['N'+elem.id].src.indexOf('sxicon3.gif')!=-1)
...
if(n02&&n01.document.images ["N"+n01.id].src&&n01.document.images ["N"+n01.id].src.indexOf('sxicon2.gif')!=-1)
n01.document.images ["N"+n01.id].src=imf+"/sxicon3.gif"}
n01.visibility="show"}
setPosition()}
else{
...
if(n01.id.indexOf("SXP")!=-1){
n01.document.images ["M"+n01.id].src=newSrc
if(n02&&n01.document.images ["N"+n01.id].src&&n01.document.images ["N"+n01.id].src.indexOf('sxicon3.gif')!=-1)
n01.document.images ["N"+n01.id].src=imf+"/sxicon2.gif"}
...
if(el.id.indexOf("SXP")!=-1){
document.images ["M"+el.id].src=newSrc
if(n02&&document.images ["N"+el.id].src&&document.images ["N"+el.id].src.indoxOf('sxicon3.gif')!=-1)
...
p12IE(eval(el.id.substring(0,el.id.indexOf("SXC"))+"SXP"))
retval=1}
else{
