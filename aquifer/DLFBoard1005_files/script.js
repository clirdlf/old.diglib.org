...
var gDocTable = new Array(
   ...
   new hrefList("slide0047.htm", 1, 7),
   new hrefList("slide0046.htm", 1, 8),
   ...
   new hrefList("slide0036.htm", 1, 15),
   new hrefList("slide0038.htm", 1, 16),
   new hrefList("slide0037.htm", 1, 17),
   new hrefList("slide0039.htm", 1, 18),
   new hrefList("slide0031.htm", 1, 19),
   new hrefList("slide0033.htm", 1, 20),
   new hrefList("slide0032.htm", 1, 21),
   new hrefList("slide0017.htm", 1, 22),
   new hrefList("slide0021.htm", 1, 23),
   new hrefList("slide0023.htm", 1, 24),
   new hrefList("slide0024.htm", 1, 25),
   new hrefList("slide0041.htm", 1, 26),
   new hrefList("slide0050.htm", 1, 27),
