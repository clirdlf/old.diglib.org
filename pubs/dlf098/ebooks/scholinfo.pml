\v
TITLE="Dimensions and Use of the Scholarly Information Environment: Introduction"
AUTHOR="Amy Friedlander"
PUBLISHER="CLIR"
EISBN=""
COPYRIGHT="2002 Council on Library and Information Resources"
\v\X0\bDimensions and Use of the Scholarly Information Environment \b\X0
\p\X1\bIntroduction to a Data Set Assembled by the Digital Library Federation and Outsell, Inc. \b\X1
...
\X2\bDigital Library Federation and Council on Library and Information Resources
Washington, D.C. \b\X2
\w="100%"

\cCopyright 2002 by the Council on Library and Information Resources. No part of this publication may be reproduced or transcribed in any form without permission of the publisher. Requests for reproduction should be submitted to the Director of Communications at the Council on Library and Information Resources.
\c \w="100%" 
\X0\bAbout the Author \b\X0 

Amy Friedlander is special projects associate at the Council on Library and Information Resources. She is primarily responsible for CLIR's work with the Library of Congress on its National Digital Information Infrastructure Preservation Program (NDIIPP). Before joining CLIR, she was the founding editor of \iD-Lib Magazine \i and \iiMP: The Magazine on Information Impacts \i. She has published on the implications of higher education for the historical role of women and on the history of large-scale technology-based infrastructures.

\Q="preface"\X0\bPreface 

\b\X0 We know from anecdotal evidence that users' expectations of libraries are changing as they find more information directly from the Web. Anecdotal evidence, though, is hardly enough for developing persuasive plans for new library services. The Digital Library Federation (DLF) and Council on Library and Information Resources (CLIR) commissioned Outsell, Inc., to conduct a large-scale study of undergraduates, graduate students, and faculty members from academic institutions ranging from the small liberal arts college to the largest research university. Our hope was that a picture of user behavior would emerge.
...
President, CLIR \i
\r \w="100%"
\p\X0\bIntroduction \b\X0 \w="100%" Academic and research libraries face numerous challenges in managing their information resources in the digital age. Like many other organizations, the Digital Library Federation (DLF) has become concerned about changing patterns of information use for teaching, learning, and research and about the implications of these patterns for libraries and library directors, who require reliable information for strategic planning. In collaboration with the Council on Library and Information Resources (CLIR) and Outsell, Inc., the DLF has initiated a planning and research process to understand how library use is changing and to support future investigation and analysis. The survey conducted by Outsell and described herein is only one of several activities under way or recently completed. Related projects include:

\a149\t A survey by DLF Distinguished Fellow Denise Troll Covey of methods applied by leading research libraries to assess the use and usability of online collections and services (Troll Covey 2002) \t
\a149\t A survey by former DLF Director Daniel Greenstein and Indiana University Dean of Libraries Suzanne Thorin of the policy, organizational, and financial environments in which leading research libraries are developing their digital libraries (Greenstein and Thorin 2002) \t
\a149\t A study by Charles McClure and colleagues into methods of assessing quality in digital reference services (McClure et al. 2002) \t
...
In this document, the tables have been grouped in three categories: (1) \iFaculty and Students \i; (2) \iInfrastructure, Facilities, and Services \i; and (3) \iFormats \i. The information presented in the tables overlaps to some extent; however, the tables included in \iFaculty and Students \i primarily contain data about who participated and what they do. Tables included in \iInfrastructure, Facilities, and Services \i contain data related to where faculty and students access information. Finally, tables grouped within \iFormats \i contain comparative data on the formats and media that faculty and students use for research, teaching, and coursework. \Q="data" \w="100%"
\p\X0\bData Collection \b\X0 

Data were collected at three types of institutions of higher education: public (state-funded) universities, private doctoral research institutions, and liberal arts colleges. These categories correspond as follows to the Carnegie Classification of Institutions of Higher Education \Sp2 \Sp:

\bStudy Classification \b
\bCarnegie Classification \b

Leading public (state-funded) research university
Doctoral Research Universities-Extensive -- Public Institutions

Leading private research university
Doctoral Research Universities-Extensive -- Private, Not-for-Profit Institutions

Leading liberal arts colleges
Baccalaureate Colleges-Liberal Arts -- Private, Not-for-Profit Institutions
...
Just under 80 percent (79.5%) of all respondents in the subgroup of faculty members and graduate students who teach reported that when they use print/hard journals, they use them at or borrow them from the library (Table 80). For 57.6 percent, the library is the preferred venue. This finding appears consistent across all institution types and disciplines, although the liberal arts colleges and arts and humanities are somewhat more prominently represented (62.3% and 62.5%, respectively). Somewhat over one-fourth of all respondents in this subgroup (26.9%) said that they found these journals online. Otherwise, respondents find print/Hard-copy journals in a variety of ways: through personal collections, personal subscriptions, interlibrary loan, course Web sites, and the campus bookstore, and from colleagues and collections within their departments, on-demand document delivery services, and publishers.
...
Among those faculty members and graduate students who use electronic journals for teaching, 80.5 percent reported finding the materials online, and this is the preferred source for 75.3 percent of the respondents  
(Table 86). Another 22.7 percent borrow or use e-journals at the library, but only 14.7 percent consider this a preferred strategy. In addition, respondents in this subgroup employ a broad range of strategies and tools: access in their offices, on-demand document delivery, interlibrary loan, and purchase. Less than 1 percent (0.6%) own e-journals in their personal collections, and less than 1 percent (0.6%) acquire them from the publishers directly. The low level of ownership suggests that, at least for teaching purposes, faculty and graduate students rely on third-party access, presumably the library, which may make the material available online through its Web site. This suggestion, which is consistent with earlier observations about reliance on the library's Web site, points to the importance of the Web site as an element in the infrastructure of higher education. This topic might be profitably explored in future studies.
...
5 In the tables, both mean and median are given. In this introduction, the mean, which is the more commonly cited statistic, is given unless otherwise indicated.

6 In questions related to teaching, the study differentiated between graduate students and graduate students who are also members of the faculty.
...
8 The term "job/coursework" is employed in the more detailed tables summarized in Table 67. For use of the term, see Table 57 in the full compilation. \Q="references" \w="100%"
\p\X0\bReferences \b\X0 

Greenstein, Daniel, and Suzanne E. Thorin. 2002. \iThe Digital Library: A Biography \i. Washington, D.C.: Digital Library Federation and Council on Library and Information Resources. Available from: http://www.clir.org/pubs/abstract/pub109abst.html.

McClure, Charles, et al. 2002. \iStatistics, Measures and Quality Standards for Assessing Digital Reference Library Services: Guidelines and Procedures \i. Syracuse, N.Y., and Tallahassee, Fla.: Syracuse University and Florida State University. Available from: http://quartz.syr.edu/quality/.

Troll Covey, Denise. 2002. \iUsage and Usability Assessment: Library Practices and Concerns \i. Washington, D.C.: Digital Library Federation and Council on Library and Information Resources. Available from: http://www.clir.org/pubs/abstract/pub105abst.html. \Q="key"
\p\X0\bKey to Tables \b\X0 

The tables available at http://www.clir.org/pubs/reports/pub110/contents.html contain summaries of the survey data. Each table contains the responses to one survey question, with the possible responses down the left-hand side, and frequencies and percentages of those responses in the body of the table. The first column represents the results from the total number of respondents to the question. The remaining column headings represent subsets of respondents to that question by respondent type, institution type, discipline, and gender. The base samples for the total responding to that question and for the other subsets is listed just below the column heading.

Letters appear next to some of the values. These letters correspond to the letters beneath the column headings, and they indicate significant differences identified by statistical testing. It means that the value is statistically different from the values given for other respondent groups represented by the letters. The results are tested at the 95 percent level of confidence (that is, there is a 5 percent or less chance that the differences between the data are due to chance). The number with the greater magnitude has the significance letter attached to it, indicating that it is "significantly greater" than at least one other comparative number.
...
\w="80%"\p\X0\bList of Tables \b\X0
\p\X1\bPart I: The Sample: Faculty and Students \b\X1

\bTable Number as Referenced in Narrative \b
\bOriginal Table Number in Full Set of Data Tables \b
\bName/question \b
...
7 : 653
Are you employed full-time, part-time or are you not employed? 

8 : 654
How may years have you been working toward your current degree? 

9 : 655
What degree are you working toward? 

10 : 656
Do you live in on-campus housing or off-campus? 

11 : 657
What year of college are you in? 

12 : 4
What is your primary area of work or research/study within your college/university? 

13 : 5
For each of the following, please tell me if this is one of your responsibilities [research, teaching, service, attending classes, other]? 

14 : 587
Mean summary table (average percentages spent in research, teaching, service and coursework) 

15 : 580
On average, about how many hours did you yourself spend each week obtaining, reviewing, and analyzing information from all sources to assist you in your (teaching or research/studies)? 

16 : 183
Do you use hard copy print all of the time, most of the time, some of the time, or none of the time? [research] 

17 : 184
Do you use electronic sources all of the time, most of the time, some of the time, or none of the time? [research] 

18 : 185
Do you use some other medium all of the time, most of the time, some of the time, or none of the time? [research] 

19 : 311
Do you use hard copy print all of the time, most of the time, some of the time, or none of the time? [teaching] 

20 : 312
Do you use electronic sources all of the time, most of the time, some of the time, or none of the time? [teaching] 

21 : 313
Do you use some other medium all of the time, most of the time, some of the time, or none of the time? [teaching] 

22 : 439
Do you use hard copy print all of the time, most of the time, some of the time, or none of the time? [coursework] 

23 : 440
Do you use electronic sources all of the time, most of the time, some of the time, or none of the time? [coursework] 

24 : 441
Do you use some other medium all of the time, most of the time, some of the time, or none of the time? [coursework] 

25 : 588
What unmet needs for information types and content do you have? 

26 : 629
Major problem summary table 

27 : 630
Minor problem summary table 

28 : 601
Top two box summary table [values perceived in different forms of information access] 

\p\X1\bPart II: Infrastructure, Facilities, and Services \b\X1

29 : 54
Summary table: What equipment do you use for accessing information from your off-campus residence? 

30 : 55
Summary table: What equipment is available at the library? 

31 : 56
Summary table: What equipment do you have in your office? 

32 : 45
Thinking about the past year, what percent of the time that you are accessing information for your (teaching or research/studies) is spent at each location? 

33 : 181
What percent of the information that you use for your research comes from your institution's physical or virtual library? : 

34 : 182
What percent of the information that you use for your research comes from another source? 