...
var gDocTable = new Array(
   new hrefList("slide0154.htm", 1, 1),
   new hrefList("slide0146.htm", 1, 2),
   new hrefList("slide0155.htm", 1, 3),
   new hrefList("slide0165.htm", 1, 4),
   new hrefList("slide0169.htm", 1, 5),
   new hrefList("slide0166.htm", 1, 6),
   new hrefList("slide0157.htm", 1, 7),
   new hrefList("slide0156.htm", 1, 8)
);
