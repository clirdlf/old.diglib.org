...
var gDocTable = new Array(
   ...
   new hrefList("slide0070.htm", 1, 2),
   new hrefList("slide0004.htm", 1, 3),
   new hrefList("slide0057.htm", 1, 4),
   new hrefList("slide0060.htm", 1, 5),
   new hrefList("slide0058.htm", 1, 6),
   new hrefList("slide0078.htm", 1, 7),
   new hrefList("slide0083.htm", 1, 8),
   new hrefList("slide0074.htm", 1, 9),
   new hrefList("slide0076.htm", 1, 10),
   new hrefList("slide0062.htm", 1, 11),
   new hrefList("slide0077.htm", 1, 12),
   ...
   new hrefList("slide0082.htm", 1, 17),
   new hrefList("slide0079.htm", 1, 18)
);
