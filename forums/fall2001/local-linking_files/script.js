...
var gDocTable = new Array(
   ...
   new hrefList("slide0027.htm", 1, 4),
   new hrefList("slide0026.htm", 1, 5),
   new hrefList("slide0025.htm", 1, 6),
   new hrefList("slide0024.htm", 1, 7),
   new hrefList("slide0023.htm", 1, 8),
   new hrefList("slide0022.htm", 1, 9),
   new hrefList("slide0020.htm", 1, 10),
   new hrefList("slide0037.htm", 1, 11),
   new hrefList("slide0031.htm", 1, 12),
   ...
   new hrefList("slide0034.htm", 1, 17),
   new hrefList("slide0032.htm", 1, 18),
   new hrefList("slide0033.htm", 1, 19),
   new hrefList("slide0035.htm", 1, 20),
   new hrefList("slide0030.htm", 1, 21),
   new hrefList("slide0036.htm", 1, 22)
);
