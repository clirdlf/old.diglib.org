...
function aa_print_html ($AA_C){
    ...
    if(true||$AA_C == '400'||$AA_C == '403'||$AA_C == '405'||$AA_C[0] == '5'){
        ...
        echo '<link rel="stylesheet" type="text/css" href="/wrap/wrap.css" />';
        echo "</head><body>";
        echo '<div class="noticeofold"><div class="noticeofoldtext">';
        echo $AA_REASON_PHRASE;
        echo '</div><div class="contentofold" style="padding:40px;text-align:center;">';
        echo "<p>You were looking for: <b>".$_SERVER['REQUEST_URI']."</b></p>";
        echo "<p>$AA_MESSAGE<br>\n</p>";
        echo "<p>You could try a search:</p>";
?>
<form action="http://www.diglib.org/search" id="cse-search-box">
  <div>
    <input type="hidden" name="cx" value="011455766617528663017:9vdr6txmcue" />
...
<!--form action="http://www.diglib.org/search" id="cse-search-box"> 
	...
	<input type="hidden" name="cof" value="FORID:10" /> 
	<input type="hidden" name="ie" value="UTF-8" /> 
	<input type="text" name="q" class="default-value form-text" id="edit-keys" value="Search DLF" maxlength="255" /> 
	<input type="submit" name="search" value="Go"> 
</form-->
<?php
        echo "<p>Or you could start over on the <a href='http://www.diglib.org'>DLF home page</a>.</p>";
        echo "<p><small>$AA_C</small></p>";
