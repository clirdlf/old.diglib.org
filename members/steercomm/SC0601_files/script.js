...
var gDocTable = new Array(
   new hrefList("slide0036.htm", 1, 1),
   new hrefList("slide0108.htm", 1, 2),
   new hrefList("slide0123.htm", 1, 3),
   new hrefList("slide0125.htm", 1, 4),
   new hrefList("slide0126.htm", 1, 5),
   new hrefList("slide0106.htm", 1, 6),
   new hrefList("slide0116.htm", 1, 7),
   new hrefList("slide0115.htm", 1, 8),
   new hrefList("slide0127.htm", 1, 9),
   new hrefList("slide0120.htm", 1, 10)
);
